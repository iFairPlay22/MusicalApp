<template>
  <v-toolbar color="rgb(219, 214, 214, 0.3)" flat scroll-off-screen app>
    ...
    <v-toolbar-items class="hidden-sm-and-down">
      ...
      <v-dialog v-model="logInDialog" width="30%" persistent>
    ...
    >
      ...
      <v-btn color="rgb(233, 51, 51, 0.8)" flat @click="logInSnackbar = false">Close</v-btn>
    </v-snackbar>
    ...
    >
      ...
      <v-btn color="rgb(233, 51, 51, 1)" flat @click="signUpSnackbar = false">Close</v-btn>
    </v-snackbar>
  </v-toolbar>
</template>
